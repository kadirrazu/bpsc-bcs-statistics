    ...
    <div class="container report-container">
        <div class="row">
            ...
            <h4 class="report-title fw-bolder text-center">
                <span>রিপোর্ট ০৪/১৬</span> 
            </h4>
            <h4 class="report-title fw-bolder text-center">
                <span class="text-info">
                    সাধারণ শিক্ষা / কারিগরি শিক্ষা ক্যাডারে সুপারিশকৃত প্রার্থীদের জেন্ডারভিত্তিক পরিসংখ্যান [জেলাওয়ারী - কম্বাইন্ড ক্যাডার]
                </span>
            </h4>
            ...
            <table class="table table-bordered">
                ...
                @foreach( $cadreWise as $cadreWiseSingle )
