    ...
    <div class="container report-container">
        <div class="row">
            ...
            <h4 class="report-title fw-bolder text-center">
                <span>রিপোর্ট ০২/০৩</span> 
            </h4>
            <h4 class="report-title fw-bolder text-center">
                <span class="text-info">
                    প্রাথমিক বাছাই (প্রিলিমিলারি) পরীক্ষায় উত্তীর্ণ প্রার্থীদের জেন্ডারভিত্তিক পরিসংখ্যান (জেলা ভিত্তিক - বিভাগওয়ারী গ্রুপকৃত)
                </span>
            </h4>
            ...
            <table class="table table-bordered">
                <tr class="fw-bold text-center">
                    <td colspan="6">
                        প্রাথমিক বাছাই (প্রিলিমিলারি) পরীক্ষায় উত্তীর্ণ প্রার্থীর সংখ্যা (জেলা ভিত্তিক - বিভাগওয়ারী গ্রুপকৃত)
                    </td>
                </tr>
                <tr class="fw-bold text-center">
                    <td>ক্রমিক</td>
