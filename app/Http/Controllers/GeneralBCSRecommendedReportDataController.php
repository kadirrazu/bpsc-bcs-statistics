...
class GeneralBCSRecommendedReportDataController extends Controller
{
    ...
    public function genderWiseAllRecommendedCandidatesSubjectWise()
    {
        $configs = Config::all();
        ...
        $divisionWise = DB::table( $this->finalResultTable )
                    ->join('subjects', "{$this->finalResultTable}.b_subject", '=', 'subjects.code')
                    ->select(
                        'subjects.code',
                        'subjects.name',
                        DB::raw('COUNT(*) as total'),
        ...
        return view('reports-general-bcs.final.gender-wise-recommended-subject-wise',[
            'configs' => $configs,
            'divisionWise' => $divisionWise,
            'grandTotal' => $grandTotal,
        ]);
    ...
    public function genderWiseAllRecommendedCandidatesSubjectWiseOthers()
    {
        $configs = Config::all();
        ...
        return view('reports-general-bcs.final.gender-wise-recommended-subject-wise-others',[
            'configs' => $configs,
            'divisionWise' => $divisionWise,
            'grandTotal' => $grandTotal,
        ]);
    ...
    public function genderWiseAllRecommendedCandidatesGeneralCadreWiseDivGroup()
    {
        $configs = Config::all();
        ...
        return view('reports-general-bcs.final.gender-wise-recommended-general-cadre-wise-div-group',[
            'configs' => $configs,
            'cadreWise' => $cadreWise,
            'grandTotal' => $grandTotal,
        ]);
    ...
    public function genderWiseAllRecommendedCandidatesTechnicalCadreWiseDivGroup()
    {
        $configs = Config::all();
        ...
        return view('reports-general-bcs.final.gender-wise-recommended-technical-cadre-wise-div-group',[
            'configs' => $configs,
            'cadreWise' => $cadreWise,
            'grandTotal' => $grandTotal,
        ]);
    ...
    public function genderWiseAllRecommendedCandidatesEducationCadreWiseDivGroup()
    {
        $configs = Config::all();
        ...
        return view('reports-general-bcs.final.gender-wise-recommended-education-cadre-wise-div-group',[
            'configs' => $configs,
            'cadreWise' => $cadreWise,
            'grandTotal' => $grandTotal,
        ]);
