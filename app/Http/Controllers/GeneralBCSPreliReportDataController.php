...
class GeneralBCSPreliReportDataController extends Controller
{
    ...
    public function genderWiseAllRegisteredCandidates()
    {
        ...
        $registered = DB::table( $this->preliPassedTable )->get();
        ...
        return view('reports-general-bcs.preli.gender-wise-preli-passed',[
            'configs' => $configs,
            'total' => $total,
            'male' => $male,
            'female' => $female,
    ...
    public function genderWiseAllRegisteredCandidatesDistrctWise()
    {
        ...
        $districtWise = DB::table( $this->preliPassedTable )
                    ->join('districts', "{$this->preliPassedTable}.district_code", '=', 'districts.code')
                    ->select(
                        "{$this->preliPassedTable}.district_code",
                        'districts.name',
        ...
        $districtWiseTotal = DB::table( $this->preliPassedTable )
                    ->join('districts', "{$this->preliPassedTable}.district_code", '=', 'districts.code')
                    ->select(
                        "{$this->preliPassedTable}.district_code",
                        'districts.name',
        ...
        return view('reports-general-bcs.preli.gender-wise-preli-passed-distrct-wise',[
            'configs' => $configs,
    ...
    public function genderWiseAllRegisteredCandidatesDistrctWiseDivGroup()
    {
        ...
        return view('reports-general-bcs.preli.gender-wise-preli-passed-distrct-wise-div-group',[
            'configs' => $configs,
            'districtWise' => $districtWise,
            'grandTotal' => $grandTotal,
        ]);
    ...
    public function genderWiseAllRegisteredCandidatesDivisionWise()
    {
        ...
        $divisionWise = DB::table( $this->preliPassedTable )
                    ->join('districts', "{$this->preliPassedTable}.district_code", '=', 'districts.code')
                    ->join('divisions', 'districts.div_code', '=', 'divisions.code')
                    ->select(
                        'divisions.code',
        ...
        $divisionWiseTotal = DB::table( $this->preliPassedTable )
                    ->join('districts', "{$this->preliPassedTable}.district_code", '=', 'districts.code')
                    ->join('divisions', 'districts.div_code', '=', 'divisions.code')
                    ->select(
                        'divisions.code',
        ...
        return view('reports-general-bcs.preli.gender-wise-preli-passed-division-wise',[
            'configs' => $configs,
    ...
    public function ageWiseAllRegisteredCandidates()
    {
        ...
        return view('reports-general-bcs.preli.age-wise-preli-passed',[
            'configs' => $configs,
            'ageWise' => $ageWise,
        ]);
